...
class BookingHubManager {
    ...
    renderBookingQuickFilters() {
        ...
        Object.entries(grouped).forEach(([key, group]) => {
            ...
            group.filters.forEach(({ name, filterObj }) => {
                ...
                `;
                value.textContent = sameColumns ? this.getBookingQuickFilterPreviewCount(name).toLocaleString() : '-';
                card.appendChild(value);

                // Marcar activa y lógica de click
                const isActive = this.bookingActiveFilters.includes(name);
                if (isActive) {
    ...
    toggleBookingDashboard() {
        if (this.bookingDashboardModal) {
            ...
            if (!this.bookingDashboardModal.classList.contains('hidden')) {
